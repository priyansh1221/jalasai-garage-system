...
- Apps Script backup flow carries its own config and should be treated as sensitive operational material
...
3. Verify Apps Script files contain only the credentials and IDs intended for the operator environment.
